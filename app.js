...
const store = new MongoDBStore({
    //process is a node global object in node app
    // part of node core runtime
    uri: process.env.MONGO_URL+process.env.MONGO_DBNAME,
...
//secures response headers
// helmet libary secure our response header and protects us from any vulnerabilty
app.use(helmet());
